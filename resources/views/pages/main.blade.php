    ...
    <div class="content-wrapper w-container">
      <div class="header-centered">
        ...
        <div class="subtitle-centered-box less-border">
            ...
            <!--send form method-->
            @if(session('message'))
            <div id="formsuccess" onclick="showHide()">
