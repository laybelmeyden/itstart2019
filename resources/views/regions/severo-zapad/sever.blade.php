...
<section id="about__1">
  <div class="container">
    <div class="row">
      ...
      <div class="col s12">
      <p class="p_regions">
      С 17 по 19 апреля 2020 года пройдет IT-школа Северо-Западного федерального округа в Калининграде.<br><br>

IT-школа представляет собой три дня интенсивного обучения и практических занятий по уникальным методикам, разработанным экспертами и тренерами всероссийской программы «IT-Start».
<br><br>
К участию в школе приглашаются предприниматели и студенты, увлеченные решением социальных проблем с помощью цифровых технологий.
<br><br>
В рамках школы объявлен конкурс на лучший проект в области инклюзии. Победители будут приглашены в полуфинал международного конкурса социальных инноваций МТС «Social Idea» (<a href="https://socialidea.ru">https://socialidea.ru</a>)
<br><br>
Причины прийти на окружную IT-школу:
<br><br>
* Возможность поработать с профильными экспертами из Москвы и Калининграда. Никаких скучных лекций! Только практические мастер-классы и работа в малых группах;
<br>
* Шанс «прокачать» свой проект или придумать классную IT-идею;
<br>
* Собрать команду проекта;
<br>
* Реализовать идею социального бизнеса;
<br>
* Подготовить качественную презентацию;
<br>
* Участвовать в деловом нетворкинге. Именно на таком мероприятии вы сможете найти партнеров и единомышленников;
<br>
* Провести аудит технологических и социальных проектов и подготовить заявки на получение проектного финансирования;
<br>
* Получить ценные призы и подарки;
<br>
* Возможность пройти в финал Международного конкурса «Social Idea»
<br>
Иногородним участникам предоставляется скидка 10% в отеле "Дона", на время мероприятия. (Пл. Маршала Василевского, 2)
        </p>
      </div>
...
<div data-ix="move-up-on-scroll" class="w-dyn-list">
    ...
    <div class="team-member-description">
      ...
      <p class="paragraph ">Контактное лицо в Москве <br><i class="fab fa-whatsapp"></i>8 915 310 34 47  <br> ns@rusinnovations.com</p>
    </div>
