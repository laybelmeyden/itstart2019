    ...
    <div class="content-wrapper w-container">
        <div class="row" id="banner">
            <div class="col-md-12">
                ...
                <h1 class="region_h1">Молодежная IT-школа «IT-Start» <br> <span style="font-size:40px;">sibirkiy.blade.phpR</span></h1>


            </div><p id="date">ЦЕНТР 21-23 декабря 2018<br> sibirkiy.blade.php АО</p>
        </div>
